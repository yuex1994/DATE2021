...
int main() {
  ...
  // build the model
  PMESH_L2_PIPE1_ILA pipe1;
  PMESH_L2_PIPE2_ILA pipe2;
  ...
  std::string OutputPath  = RootPath    + "/verification-pipe1/";
  ...
  VerilogVerificationTargetGenerator vg(
      ...
      "l2",                                                  // top_module_name
      RefrelPath + "ref-rel-var-map-l2-pipe1.json",                // variable mapping
      RefrelPath + "ref-rel-inst-cond-l2-pipe1.json",              // conditions of start/ready
      OutputPath,                                            // output path
      pipe1.model.get(),                                           // model
  ...
  OutputPath  = RootPath    + "/verification-pipe2/";

  VerilogVerificationTargetGenerator vg2(
      {IncludePath},                                         // one include path
      path_to_design_files,                                  // designs
      "l2",                                                  // top_module_name
      RefrelPath + "ref-rel-var-map-l2-pipe2.json",                // variable mapping
      RefrelPath + "ref-rel-inst-cond-l2-pipe2.json",              // conditions of start/ready
      OutputPath,                                            // output path
      pipe2.model.get(),                                           // model
      VerilogVerificationTargetGenerator::backend_selector::JASPERGOLD, // backend: JASPERGOLD
      vtg_cfg,  // target generator configuration
      vlg_cfg); // verilog generator configuration
