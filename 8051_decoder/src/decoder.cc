...
DECODER::DECODER() : model("DECODER") {
...

  {
    ...
    instr.SetDecoder((mem_wait == BoolConst(0) & (wait_data == BoolConst(0)));
  }
...

  {
    ...
    instr.SetDecode((state == state_11) & (mem_wait == BoolConst(0)) & (wait_data == BoolConst(0)));
